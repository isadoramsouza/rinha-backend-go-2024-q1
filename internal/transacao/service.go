...
type Service interface {
	CreateTransaction(ctx context.Context, t domain.Transacao, saldo int64) error
...
func (s *transacaoService) CreateTransaction(ctx context.Context, t domain.Transacao, saldo int64) error {
	err := s.repository.SaveTransaction(ctx, t, saldo)
